...
@Table(name = StandardRules.DB_TABLE)
@Entity(name = "StandardRules")
...
public class StandardRules extends ODataEntity implements Serializable{
	
	private static final long serialVersionUID = 1L;

	public static final String DB_TABLE = "\"_SYS_BIC\".\"sap.ain.views.rule/StandardRules\"";
	...
	public Integer getNoOfAssignedEquipment() {
		return noOfAssignedEquipment;
	}

	public void setNoOfAssignedEquipment(Integer noOfAssignedEquipment) {
		this.noOfAssignedEquipment = noOfAssignedEquipment;
	}
	...
	public Integer getTotalNoOfEquipment() {
		return totalNoOfEquipment;
	}

	public void setTotalNoOfEquipment(Integer totalNoOfEquipment) {
		this.totalNoOfEquipment = totalNoOfEquipment;
	}
