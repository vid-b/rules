...
public class AssignEquipmentToObjectValidator implements ConstraintValidator<AssignEquipmenttoObjectValidations, Object[]> {
	...
	@Override
	public void initialize(AssignEquipmenttoObjectValidations constraintAnnotation) {
	...
	public boolean isValid(Object[] values, ConstraintValidatorContext context) {
		...
		if(!validations.isEquListValid(businessObjects.getEquipmentIds() ,businessObjects.getSubjectId(), ruleId)) {
